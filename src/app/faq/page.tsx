    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "You can reach our customer support team through our contact page, by email at support@servicefinder.ae, or by using the chat feature available on our website during business hours."
        }
      ]
    },
    {
            ...
            <div key={catIndex} className="mb-12">
              ...
              <div className="space-y-4">
                {category.items.map((faq, index) => {
                  const globalIndex = catIndex * 100 + index; // Unique index across all categories
                  return (
                    <div 
                      key={globalIndex} 
